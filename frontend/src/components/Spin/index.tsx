      ...
      >
        <g className="spin">
          ...
          >
            <stop
              offset="0"
              style={{ stopColor: theme === 'light' ? '#F0EEE9' : '#6667ab' }}
            />
            <stop
              offset="1"
              style={{ stopColor: theme === 'light' ? '#B1B1B1' : '#8B8BBA' }}
            />
          </linearGradient>
          <path
            style={{ fill: `url(#${rightId})` }}
          ...
          >
            <stop
              offset="0"
              style={{ stopColor: theme === 'light' ? '#8B8BBA' : '#B1B1B1' }}
            />
            <stop
              offset="1"
              style={{ stopColor: theme === 'light' ? '#B1B1B1' : '#8B8BBA' }}
